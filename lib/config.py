...
# path
CONF.PATH = EasyDict()
CONF.PATH.BASE = "/data2/guofan/Language-Assisted-3D" # TODO: change this
...
print("===================================================")
print("Loading scannet data from", CONF.PATH.SCANNET_DATA)
print("===================================================")

# data
CONF.SCANNET_DIR =  os.path.join(CONF.PATH.SCANNET, 'scans')
CONF.SCANNET_FRAMES_ROOT = "/sharecephfs/data/ScanNet/ScanNet/frames_square" # TODO change this if use multiview
CONF.PROJECTION = "/sharecephfs/data/ScanNet/ScanNet/multiview_projection_scanrefer" # TODO change this if use multiview
CONF.ENET_FEATURES_ROOT = "/sharecephfs/data/ScanNet/ScanNet/enet_features" # TODO change this if use multiview
...
CONF.ENET_WEIGHTS = os.path.join(CONF.PATH.BASE, "data/data_temp/data/scannetv2_enet.pth")
# CONF.MULTIVIEW = os.path.join(CONF.PATH.SCANNET_DATA, "enet_feats.hdf5")
CONF.MULTIVIEW = os.path.join(CONF.PATH.DATA, "enet_feats_maxpool.hdf5")
